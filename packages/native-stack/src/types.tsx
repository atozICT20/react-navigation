...
export type NativeStackNavigationOptions = {
   ...
   * The following values are currently supported:
   * - "card" – the new screen will be pushed onto a stack which on iOS means that the default animation will be slide from the side, the animation on Android may vary depending on the OS version and theme.
